...
class MakeDomainJob extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:domain-job';
     ...
     * @var string
     */
    protected $description = 'Create a new Domain Job in the DDD structure.';
    ...
    protected function getNameInput()
    {
        ...
        $namespace = $this->rootNamespace() . '\\Domain\\' . $domain . '\\Jobs';
    ...
    {
        return base_path('stubs/domain.job.stub');
    }
    ...
    {
        return [
            ['domain', InputArgument::REQUIRED, 'The Domain name for the job (e.g., User, Order).'],
            ['name', InputArgument::REQUIRED, 'The name of the Domain Job.'],
        ];
    }
