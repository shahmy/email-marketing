...
class MakeDomainDto extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $description = 'Create a new Domain Data Transfer Object (DTO) in the DDD structure.';
    ...
    protected function getNameInput()
    {
        ...
        $namespace = $this->rootNamespace() . '\\Domain\\' . $domain . '\\DataTransferObjects';
    ...
    {
        $domain = trim($this->argument('domain'));
        return $rootNamespace.'\\Domain\\'.$domain.'\\DataTransferObjects';
    }
    ...
    {
        return [
            ['domain', InputArgument::REQUIRED, 'The Domain name for the DTO (e.g., User, Order).'],
            ['name', InputArgument::REQUIRED, 'The name of the Domain DTO.'],
        ];
    }
